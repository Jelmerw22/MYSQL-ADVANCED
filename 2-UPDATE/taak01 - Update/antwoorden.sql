...
-- Opdracht 2 
UPDATE studenten2 SET adres = 'Prinsgracht 2', postcode = '1772XL' WHERE student_id = '8';
UPDATE studenten2 SET adres = 'Europlaan 254', postcode = '8793BV' WHERE student_id = '9';
UPDATE studenten2 SET adres = 'Texellaan 66', postcode = '6523HL' WHERE student_id = '10';
-- Opdracht 3
